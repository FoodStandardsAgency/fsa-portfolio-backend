CREATE TABLE [dbo].[PortfolioConfigurations] (
    ...
    [ArchiveAgeDays]    INT DEFAULT ((90)) NOT NULL,
    [ArchivePhase_Id]   INT NULL,
    ...
    CONSTRAINT [FK_dbo.PortfolioConfigurations_dbo.ProjectPhases_ArchivePhase_Id] FOREIGN KEY ([ArchivePhase_Id]) REFERENCES [dbo].[ProjectPhases] ([Id]),
...
GO
CREATE NONCLUSTERED INDEX [IX_ArchivePhase_Id]
    ON [dbo].[PortfolioConfigurations]([ArchivePhase_Id] ASC);
